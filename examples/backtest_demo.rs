use backtesting::{BacktestEngine, MarketDataBar, OHLCV};
use strategies::MeanReversionStrategy;
...
fn main() {
    ...
    println!("Max DD Duration: {:.1} days", metrics.max_drawdown_duration_days);
...
fn generate_market_data() -> Vec<MarketDataBar> {
    use rand::Rng;
